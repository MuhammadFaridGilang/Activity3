...
public class ListViewAdapter extends BaseAdapter {
    ...
    //Fungsi ini digunakan untuk mendapatkan item yang terkait dengan posisi tertentu dalam kumpulan
    //data untuk mendapatkan data yang sesuai dari lokasi  tertentu dalam pengumpulan data item
    @Override
    ...
    //Fungsi ini secara otomatis dipanggil ketika tampilan item list siap untuk ditampilkan atau
    //akan ditampilkan
    @Override
